if (localStorage.getItem("cintura") != null) {
    confirmacao = confirm('Você já realizou o teste, quer fazer de novo?');
    if (confirmacao == true) {
...
const texto = "Primeiro, tire a medida da circunferência da cintura com o auxílio de uma fita métrica:";
...
function criarBotoes () {
    ...
    botao.addEventListener("click", () => {
        localStorage.setItem("cintura", input.value);
        window.location.href = "slidetmb3.html";
        });
}
